...
class LegendItem extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <Flexbox style={{padding: '0px 5px'}}>
          <Flexbox alignItems='center' width='20px'>
            {symbol}
          </Flexbox>
          <Flexbox>
            <Flexbox>
...
export default class Legend extends React.Component {
  ...
  styleMode(category) {
    ...
    const isSelected = Array.isArray(this.props.selection)
      ? this.props.selection.includes(category.key)
      : this.props.selection && category.key  === this.props.selection;
  ...
  render() {
    ...
    const align = this.props.align === 'center'
      ? 'center'
      : this.props.align === 'left' ? 'flex-start' : 'flex-end';
