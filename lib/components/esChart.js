...
class esChart extends Component {
  ...
  getLegendStyle(column) {
    const color = this.colorList[this.getColorIndex(column)].backgroundColor;
    return { 
      symbol: {
        normal: {stroke: '#c0c0c0', fill: 'none', strokeWidth: 1},
  ...
  handleZoomValueChange(value) {
    ...
    const interval = setInterval(() => {
      ++i;
      this.handleTimeRangeChange(new TimeRange(new Date( currentStart + deltaStart * i), new Date(currentEnd + deltaEnd * i )));
      ...
      <div className='container-fluid'>
        ...
        <div className='row'>
          <div className='col-md-5'>
            ...
            <ToggleOptions list={[ '1y', '3y', '5y', '10y', 'All']} default={'All'} name={'zoomRange'} valueChange={this.handleZoomValueChange}/>
          </div>
